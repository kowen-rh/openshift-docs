...
* Previously, nodes were formatted with an XFS filesystem in read-write mode. With this release, nodes use a read-only ComposeFS filesystem which reports full disk usage, making the filesystem immutable. (link:https://issues.redhat.com/browse/OCPBUGS-52485[OCPBUGS-52485])
